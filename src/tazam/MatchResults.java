 ...
 * respective histograms of matches.
 *
 */
public class MatchResults {
    ...
    /**
     * The results of the matching process. The key is the id of the song that
     * matches, the histogram is the count at particular time intervals
     */
     ...
     * @param dataPoints The list of data points that was mapped to an identical
     * probe.
     */
