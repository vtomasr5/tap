 ...
 * the time offset (dt) between the probe to match and the probe in the
 * constructed index. There is one histogram for each track in the index.
 *
 */
public class Histogram {

    /**
     * List of all the matches. Key is the time offset, value is the number of
     * matches the time offset
     */
     ...
     *
     * @return The total matches for at all the dt's of the particular
     * histogram.
     */
    ...
    /**
     * Gets the maximum match at any given delta, and returns that as a <delta,
     * number matched> pair
     *
     ...
     *
     * @return The string representation of all the match results of this
     * histogram.
     */
