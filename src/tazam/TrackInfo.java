package tazam;
/**
 * TrackInfo is the mapped value for each TrackID. TrackInfo contains both the
 * trackID ( track number in the index ) and the stringed description.
 *
 */
public class TrackInfo implements java.io.Serializable {
    ...
    public boolean equals(Object otherObject) {
        ...
        if (this == otherTrackInfo) {
            return true;
        }
        if (this.oTrackID == otherTrackInfo.getTrackID() && this.description.equals(otherTrackInfo.description)) {
            return true;
        }
        return false;
    }
