package tazam;
/**
 * Each probe has a specific probeDataPoint mapped to it. This value is unique,
 * because the index of each probe inside the spectrogram is different, and the
 * trackID is different for those probes that have the same index.
 *
 */
public class ProbeDataPoint {
    ...
    /**
     * Constructs a probeDataPoint, located at the specified index in the audio
     * clip, with the given trackID.
     *
    ...
    public boolean equals(Object otherObject) {
        ...
        if (this.trackID == oDataPoint.trackID && this.index == oDataPoint.index) {
            return true;
        }
        return false;
    }
